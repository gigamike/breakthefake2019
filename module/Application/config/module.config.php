    ...
    'router' => array(
        'routes' => array(
            ...
            'member-site' => array(
                'type' => 'segment',
                'options' => array(
                    'route'    => '/member-site[/:action][/:id][/page/:page][/search_by/:search_by]',
                    'constraints' => array(
                        'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
                        'id' => '[0-9]+',
                        'page' => '[0-9]+',
                    ...
                    'defaults' => array(
                        'controller' => 'Member\Controller\Site',
                        'action'     => 'index',
                    ),
                ),
            ),
            ...
            'yellow-pages' => array(
                'type' => 'segment',
                'options' => array(
                    'route'    => '/yellow-pages[/:action][/:id][/page/:page][/search_by/:search_by]',
                    'constraints' => array(
                        'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
                        'id' => '[0-9]+',
                        'page' => '[0-9]+',
            ...
            'articles' => array(
                'type' => 'segment',
                'options' => array(
                    'route'    => '/articles[/:action][/:id][/page/:page][/search_by/:search_by]',
                    'constraints' => array(
                        'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
                        'id' => '[0-9]+',
                        'page' => '[0-9]+',
                    ...
                    'defaults' => array(
                        'controller' => 'Site\Controller\Article',
                        'action'     => 'index',
                    ),
                ),
            ),
